            ...
            #             data_format["img"].setdefault("img_source{}".format(str(count)), link.get("src"))
                ...
                for link in links:
                    if "twitter.png" in str(link.get("src")):
                        ...
                        count += 1
                      git  data_format["img"].setdefault("img_source{}".format(str(count)), link.get("src"))
            else:
                for link in links:
                    if "twitter.png" in str(link.get("src")):
                        pass
